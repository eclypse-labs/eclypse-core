...
//TODO: Import MAI TOKEN

import "@uniswap-periphery/libraries/TransferHelper.sol";


contract PositionsManagerMAI is Ownable, IPositionsManager {
    ...
    function initialize(
        ...
        protocolContracts.stableCoin = _maiAddress;
        MAI = MaiToken(_maiAddress);
    }
    ...
    public returns (bool) {
        ...
        uint256 debt = debtOf(_tokenId);
        require(_amountRepay >= debt, "The amount of MAI to repay is not enough to reimburse the debt of the position.");

        //TODO: Transfer MAI from liquidator to vault.
    ...
    public override returns (bool hasBeenLiquidated)
    {
        ...
        require(debtOf(_tokenId) <= _amountRepay, "Not enough MAI to repay debt");
