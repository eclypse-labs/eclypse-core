...
//         activePool.decreaseLiquidity(
//             facticeUser1_tokenId, lpPositionsManager.getPosition(facticeUser1_tokenId).liquidity / 2, facticeUser1
//         );
//         vm.stopPrank();
//         assertEq(
//             lpPositionsManager.getPosition(facticeUser1_tokenId).liquidity,
//             previousLiquidity / 2,
//             "Position should have half liquidity."
//         );
//     }
// }
