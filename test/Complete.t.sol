...
contract CompleteTest is Test {
    ...
    function setUp() public {
        vm.createSelectFork("https://rpc.ankr.com/eth", 16541360);
        //vm.createFork("https://rpc.ankr.com/eth", 16_153_817);
        ...
        (user1_tokenId1, , , ) = uniswapPositionsNFT.mint(createMintParams(
            100,
            115135,
            276324,
            280989067,
        ...
        (user4_tokenId2, , , ) = uniswapPositionsNFT.mint(createMintParams(
            100,
            202667,
            207243,
            50000 * TOKEN6,
        ...
        (user4_tokenId3, , , ) = uniswapPositionsNFT.mint(createMintParams(
            100,
            201936,
            207243,
            12052947528,
        ...
        (user5_tokenId2, , , ) = uniswapPositionsNFT.mint(createMintParams(
            100,
            200311,
            207243,
            50000 * TOKEN6,
        ...
        (user5_tokenId3, , , ) = uniswapPositionsNFT.mint(createMintParams(
            100,
            200311,
            207243,
            8215000547,
    ...
    function createMintParams(uint24 fees, int24 lower, int24 upper, uint256 amount0, uint256 amount1, address sender) public view returns (INonfungiblePositionManager.MintParams memory){
    ...
    function testComplete() public {
        ...
        assertEq(activePool.getMintedSupply(), GHOAmount, "GHOAmount1_1 should have been minted.");
        assertEq(lpPositionsManager.debtOf(user1_tokenId1), GHOAmount, "The debt of user1 position 1 should be of GHOAmount1_1.");

        borrowerOperation.borrowGHO(GHOAmount, user1_tokenId2);
        assertEq(activePool.getMintedSupply(), GHOAmount + GHOAmount, "GHOAmount1_1 + GHOAmount1_2 should have been minted.");
        assertEq(lpPositionsManager.debtOf(user1_tokenId2), GHOAmount, "The debt of user1 position 2 should be of GHOAmount1_2.");

        borrowerOperation.borrowGHO(GHOAmount, user1_tokenId3);
        assertEq(activePool.getMintedSupply(), GHOAmount + GHOAmount + GHOAmount, "GHOAmount1_1 + GHOAmount1_2 + GHOAmount1_3 should have been minted.");
        assertEq(lpPositionsManager.debtOf(user1_tokenId3), GHOAmount, "The debt of user1 position 3 should be of GHOAmount1_3.");

        assertEq(lpPositionsManager.totalDebtOf(user1), GHOAmount + GHOAmount + GHOAmount, "The total debt of user1 should be of GHOAmount1_1 + GHOAmount1_2 + GHOAmount1_3.");
        ...
        assertEq(activePool.getMintedSupply(), GHOAmount3 + GHOAmount, "GHOAmount1 + GHOAmount2_1 should have been minted.");
        assertEq(lpPositionsManager.debtOf(user2_tokenId1), GHOAmount, "The debt of user2 position 1 should be of GHOAmount1_1.");

        borrowerOperation.borrowGHO(GHOAmount, user2_tokenId2);
        assertEq(activePool.getMintedSupply(), GHOAmount3 + GHOAmount + GHOAmount, "GHOAmount1 + GHOAmount2_1 + GHOAmount2_2 should have been minted.");
        assertEq(lpPositionsManager.debtOf(user2_tokenId2), GHOAmount, "The debt of user2 position 2 should be of GHOAmount1_2.");

        borrowerOperation.borrowGHO(GHOAmount, user2_tokenId3);
        assertEq(activePool.getMintedSupply(), GHOAmount3 + GHOAmount3, "GHOAmount1 + GHOAmount2_1 + GHOAmount2_2 + GHOAmount2_3 should have been minted.");
        assertEq(lpPositionsManager.debtOf(user2_tokenId3), GHOAmount, "The debt of user2 position 3 should be of GHOAmount1_3.");

        assertEq(lpPositionsManager.totalDebtOf(user2), GHOAmount + GHOAmount + GHOAmount, "The total debt of user2 should be of GHOAmount1_1 + GHOAmount1_2 + GHOAmount1_3.");
        ...
        assertEq(activePool.getMintedSupply(), GHOAmount3 + GHOAmount3 + GHOAmount, "GHOAmount1 + GHOAmount2 + GHOAmount3_1 should have been minted.");
        assertEq(lpPositionsManager.debtOf(user3_tokenId1), GHOAmount, "The debt of user3 position 1 should be of GHOAmount1_1.");
        
        borrowerOperation.borrowGHO(GHOAmount, user3_tokenId2);
        assertEq(activePool.getMintedSupply(), GHOAmount3 + GHOAmount3 + GHOAmount + GHOAmount, "GHOAmount1 + GHOAmount2 + GHOAmount3_1 + GHOAmount3_2 should have been minted.");
        assertEq(lpPositionsManager.debtOf(user3_tokenId2), GHOAmount, "The debt of user3 position 2 should be of GHOAmount1_2.");

        borrowerOperation.borrowGHO(GHOAmount, user3_tokenId3);
        assertEq(activePool.getMintedSupply(), GHOAmount3 + GHOAmount3 + GHOAmount3, "GHOAmount1 + GHOAmount2 + GHOAmount3_1 + GHOAmount3_2 + GHOAmount3_3 should have been minted.");
        assertEq(lpPositionsManager.debtOf(user3_tokenId3), GHOAmount, "The debt of user3 position 3 should be of GHOAmount1_3.");

        assertEq(lpPositionsManager.totalDebtOf(user3), GHOAmount + GHOAmount + GHOAmount, "The total debt of user3 should be of GHOAmount1_1 + GHOAmount1_2 + GHOAmount1_3.");
        ...
        assertEq(activePool.getMintedSupply(), GHOAmount3 + GHOAmount3 + GHOAmount3 + GHOAmount, "GHOAmount1 + GHOAmount2 + GHOAmount3 + GHOAmount4_1 should have been minted.");
        assertEq(lpPositionsManager.debtOf(user4_tokenId1), GHOAmount, "The debt of user4 position 1 should be of GHOAmount1_1.");

        borrowerOperation.borrowGHO(GHOAmount, user4_tokenId2);
        assertEq(activePool.getMintedSupply(), GHOAmount3 + GHOAmount3 + GHOAmount3 + GHOAmount + GHOAmount, "GHOAmount1 + GHOAmount2 + GHOAmount3 + GHOAmount4_1 + GHOAmount4_2 should have been minted.");
        assertEq(lpPositionsManager.debtOf(user4_tokenId2), GHOAmount, "The debt of user4 position 2 should be of GHOAmount1_2.");

        borrowerOperation.borrowGHO(GHOAmount, user4_tokenId3);
        assertEq(activePool.getMintedSupply(), GHOAmount3 + GHOAmount3 + GHOAmount3 + GHOAmount3, "GHOAmount1 + GHOAmount2 + GHOAmount3 + GHOAmount4_1 + GHOAmount4_2 + GHOAmount4_3 should have been minted.");
        assertEq(lpPositionsManager.debtOf(user4_tokenId3), GHOAmount, "The debt of user4 position 3 should be of GHOAmount1_3.");

        assertEq(lpPositionsManager.totalDebtOf(user4), GHOAmount + GHOAmount + GHOAmount, "The total debt of user4 should be of GHOAmount1_1 + GHOAmount1_2 + GHOAmount1_3.");
        ...
        assertEq(activePool.getMintedSupply(), GHOAmount3 + GHOAmount3 + GHOAmount3 + GHOAmount3 + GHOAmount, "GHOAmount1 + GHOAmount2 + GHOAmount3 + GHOAmount4 + GHOAmount5_1 should have been minted.");
        assertEq(lpPositionsManager.debtOf(user5_tokenId1), GHOAmount, "The debt of user5 position 1 should be of GHOAmount1_1.");
        
        borrowerOperation.borrowGHO(GHOAmount, user5_tokenId2);
        assertEq(activePool.getMintedSupply(), GHOAmount3 + GHOAmount3 + GHOAmount3 + GHOAmount3 + GHOAmount + GHOAmount, "GHOAmount1 + GHOAmount2 + GHOAmount3 + GHOAmount4 + GHOAmount5_1 + GHOAmount5_2 should have been minted.");
        assertEq(lpPositionsManager.debtOf(user5_tokenId2), GHOAmount, "The debt of user5 position 2 should be of GHOAmount1_2.");

        borrowerOperation.borrowGHO(GHOAmount, user5_tokenId3);
        assertEq(activePool.getMintedSupply(), GHOAmount3 + GHOAmount3 + GHOAmount3 + GHOAmount3 + GHOAmount3, "GHOAmount1 + GHOAmount2 + GHOAmount3 + GHOAmount4 + GHOAmount5_1 + GHOAmount5_2 + GHOAmount5_3 should have been minted.");
        assertEq(lpPositionsManager.debtOf(user5_tokenId3), GHOAmount, "The debt of user5 position 3 should be of GHOAmount1_3.");

        assertEq(lpPositionsManager.totalDebtOf(user5), GHOAmount + GHOAmount + GHOAmount, "The total debt of user5 should be of GHOAmount1_1 + GHOAmount1_2 + GHOAmount1_3.");
        ...
        assertGt(lpPositionsManager.totalDebtOf(user1), initialDebtUser1, "The total debt of user1 should have increased.");
        ...
        assertEq(lpPositionsManager.totalDebtOf(user1), initialDebtUser1, "The total debt of user1 should be the same as before.");
        ...
        assertEq(lpPositionsManager.totalDebtOf(user1), 2 * initialDebtUser1, "The total debt of user1 should be the doubled.");
        ...
        assertEq(lpPositionsManager.totalDebtOf(user2), 3183624*10**13, "The total debt of user2 should be 31.83624 GHO.");
        ...
        assertEq(lpPositionsManager.totalDebtOf(user1), 0, "The total debt of user1 should be 0.");
