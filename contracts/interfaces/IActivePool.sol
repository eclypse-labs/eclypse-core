...
interface IActivePool is IPool {
    ...
    function burnDebtToken(uint256 tokenId, uint256 amount) external;
    
    function repayInterestFromUserToProtocol(address sender, uint256 amount, uint256 tokenId) external;
    ...
    function getDebtToken(uint256 tokenId) external view returns (DebtToken debtToken);
